...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status time background_jobs ssh dir_writable)
...
POWERLEVEL9K_TIME_FOREGROUND=040
...
POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND='040'
POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND='200'
POWERLEVEL9K_BATTERY_LOW_FOREGROUND='202'
