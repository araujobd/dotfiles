# Generated by Powerlevel10k configuration wizard on 2020-12-19 at 23:14 -03.
...
function prompt_my_cpu_temp() {
  ...
  elif (( cpu_tem >= 55 )); then
    p10k segment -s WARM   -f yellow -i '' -t "${cpu_temp}"
  else
    p10k segment -s COLD -f blue -i '' -t "${cpu_temp}"
  fi
}
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=47
